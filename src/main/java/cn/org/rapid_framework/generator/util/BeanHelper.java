...
public class BeanHelper {
    ...
    static final List<String> PRIMARY_KEY_PROPERTIES=new ArrayList<String>();
    static
    {
        PRIMARY_KEY_PROPERTIES.add("idColumn");
        PRIMARY_KEY_PROPERTIES.add("pkColumn");
	...
	public static Map describe(Object obj) {
		...
		for(int i = 0; i < descriptors.length; i++ ) {
			...
			if (readMethod != null) {
                boolean flag=true;
			    if(PRIMARY_KEY_PROPERTIES.contains(name)){
