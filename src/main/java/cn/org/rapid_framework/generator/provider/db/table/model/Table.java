...
public class Table implements java.io.Serializable,Cloneable {
	...
	String className;
	String entityName;
	boolean viewController;
	
	public boolean isViewController() {
		return viewController;
	}

	public void setViewController(boolean viewController) {
   ...
   public Column getRequiredColumnBySqlName(String sqlName) {
	...
	String seqPrefixes= TableFactory.getInstance().getSeqPrefixes();
	
	public String getSeqPrefixes() {
		return seqPrefixes;
	}
